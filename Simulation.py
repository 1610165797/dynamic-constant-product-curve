...
from sympy import symbols, solve, diff, nsolve
...
if __name__ == "__main__":
    ...
    head1 = Curve(x0, y0, k, mkp)
    #print("optimality: ", optimal(head1, xf, trade_limit))
    #plot_optimal(head1, xf, trade_limit)
    print(LaGrange(head1, xf, trade_limit))
    #head2 = Curve(x0, y0, k, mkp)
    #print(plt.figure(),exhaustive(head2, xf, [], 0, params[0]))
    # head2.onetime_trade(xf)
    plt.grid()
    plt.show()
